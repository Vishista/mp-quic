...
type flowController struct {
	...
	rttStats             *congestion.RTTStatsManager
...
func newFlowController(streamID protocol.StreamID, contributesToConnection bool, connectionParameters handshake.ConnectionParametersManager, rttStats *congestion.RTTStatsManager) *flowController {
	fc := flowController{
		streamID:                streamID,
