...
var InitialCongestionWindow PacketNumber

func SetInitialCongestionWindow(window int) {
	InitialCongestionWindow = PacketNumber(window)
}
...
var ReceiveStreamFlowControlWindow ByteCount

// ReceiveConnectionFlowControlWindow is the connection-level flow control window for receiving data
// This is the value that Google servers are using
var ReceiveConnectionFlowControlWindow ByteCount

func SetInitialReceiveStreamFlowControlWindow(n int) {
	ReceiveStreamFlowControlWindow = ByteCount((1 << 10) * n)     // n kB
	ReceiveConnectionFlowControlWindow = ByteCount((1 << 10) * n) // n kB
